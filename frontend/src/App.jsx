...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .run-btn:hover:not(:disabled) {
    ...
    box-shadow: 0 4px 20px #0ff2b240;
  }
  ...
  return (
    <div className={`email-card ${isDone ? "done" : ""}`}>
      <div className="card-header">
        <div
          className="cat-icon"
          style={{ background: catStyle.bg, border: `1px solid ${catStyle.border}20`, color: catStyle.text }}
        >
          {CATEGORY_ICONS[cat]}
        </div>
      ...
      <div className="summary-box">
        ...
        {analysis.key_info && (
          <div style={{ marginTop: 5 }}>
            <strong>Key info:</strong> {analysis.key_info}
          </div>
        )}
      </div>
      ...
      {!isDone && (
        <div className="actions">
          <button
            ...
            disabled={loading || !analysis.draft_reply}
          >
...
export default function App() {
  ...
  async function triggerRun() {
    ...
    setTimeout(() => { fetchAll(); setRunning(false); }, 3000);
  }
      ...
      <div className="main">
        ...
        {stats && (
          <div className="stats-row">
            ...
            <div className="stat-card highlight-sent">
              <div className="stat-label">Sent</div>
              <div className="stat-value">{stats.sent}</div>
            </div>
            <div className="stat-card highlight-rejected">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            <div className="empty-icon">◎</div>
            <div className="empty-text">No emails here · Click Run Now to fetch</div>
          </div>
        ) : (
          filtered.map(item => (
            <EmailCard
