...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .topbar { position: sticky; top: 0; z-index: 100; background: #080a0fcc; backdrop-filter: blur(20px); border-bottom: 1px solid #ffffff0d; padding: 0 32px; height: 60px; display: flex; align-items: center; gap: 20px; }
  ...
  .run-btn { padding: 8px 20px; background: #0ff2b2; color: #080a0f; border: none; border-radius: 6px; font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500; cursor: pointer; transition: all 0.2s; letter-spacing: -0.01em; }
  ...
  .approve-btn { flex: 1; padding: 10px; background: #0ff2b215; color: #0ff2b2; border: 1px solid #0ff2b230; border-radius: 7px; font-size: 13px; font-weight: 500; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.15s; letter-spacing: -0.01em; }
